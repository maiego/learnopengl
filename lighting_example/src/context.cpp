...
bool Context::Init()
{
    ShaderPtr vertexShader = Shader::CreateFromFile("/lighting.vs", GL_VERTEX_SHADER);
    ShaderPtr fragmentShader = Shader::CreateFromFile("/lighting.fs", GL_FRAGMENT_SHADER);
...
void Context::Render()
{
    ...
    if (ImGui::Begin("UI window"))
    {
        ...
        {
            ImGui::DragFloat3("m.ambient", glm::value_ptr(m_material.ambient), 0.01f, 0.0f, 1.0f);
            ImGui::DragFloat3("m.diffuse", glm::value_ptr(m_material.diffuse), 0.01f, 0.0f, 1.0f);
            ImGui::DragFloat3("m.specular", glm::value_ptr(m_material.specular), 0.01f, 0.0f, 1.0f);
    ...
    // light 에 cube 그리기
    {
        ...
        m_program->SetUniform("light.diffuse", glm::vec3(1.0f));
        m_program->SetUniform("light.specular", glm::vec3(1.0f));
        m_program->SetUniform("material.ambient", glm::vec3(1.0f));
        m_program->SetUniform("material.diffuse", glm::vec3(1.0f));
        m_program->SetUniform("material.specular", glm::vec3(1.0f));
